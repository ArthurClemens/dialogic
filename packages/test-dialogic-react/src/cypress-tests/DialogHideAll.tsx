    ...
    <div className="test">
      ...
      <div className="control" data-test-id="hide-all">
        <div className="buttons">
          ...
          <button className="button" data-test-id="button-hide-all-spawn" onClick={() => dialog.hideAll({ spawn: "1" })}>
            Hide all with spawn
          </button>
          <button className="button" data-test-id="button-hide-all-spawn-id" onClick={() => dialog.hideAll({ id: "1", spawn: "1" })}>
