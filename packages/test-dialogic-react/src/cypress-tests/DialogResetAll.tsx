    ...
    <div className="test">
      ...
      <div className="control" data-test-id="reset-all">
        <div className="buttons">
          <button className="button" data-test-id="button-reset-all" onClick={() => dialog.resetAll()}>
            Reset all
          </button>
          <button className="button" data-test-id="button-reset-all-id" onClick={() => dialog.resetAll({ id: "1" })}>
            Reset all with id
          </button>
          <button className="button" data-test-id="button-reset-all-spawn" onClick={() => dialog.resetAll({ spawn: "1" })}>
            Reset all with spawn
          </button>
          <button className="button" data-test-id="button-reset-all-spawn-id" onClick={() => dialog.resetAll({ id: "1", spawn: "1" })}>
