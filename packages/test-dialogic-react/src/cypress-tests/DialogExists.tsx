...
export default () => {
  ...
  return (
    <div className="test">
      <div className="control" data-test-id="count-all">{`Exists any: ${dialog.exists().toString()}`}</div>
      <div className="control" data-test-id="count-id">{`Exists id: ${dialog.exists({ id: "1" }).toString()}`}</div>
      <div className="control" data-test-id="count-spawn">{`Exists spawn: ${dialog.exists({ spawn: "1" }).toString()}`}</div>
      <div className="control" data-test-id="count-spawn-id">{`Exists spawn, id: ${dialog.exists({ spawn: "1", id: "1" }).toString()}`}</div>
