...
function Instance(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: domElementCb, className }, /* @__PURE__ */ React.createElement(Component, { ...passThroughOptions, show: show2, hide: hide2 }));
}
...
function Wrapper(props) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, filtered.map((item) => /* @__PURE__ */ React.createElement(
    Instance,
    {
      key: item.key,
...
function Dialogical({ instance, ...props }) {
  useDialogicState();
  const identityOptions = {
  ...
  return /* @__PURE__ */ React.createElement(Wrapper, { identityOptions, ns: instance.ns });
}
...
const useDialogic = ({
  ...
  const [id] = React.useState(useDialogicCounter++);
  const augProps = {
    ...props,
...
const useDialog = (props) => useDialogic({
  ...props,
  instance: dialog
});
...
function UseDialogic(props) {
  useDialogic(props);
  return null;
}
function UseDialog(props) {
  return /* @__PURE__ */ React.createElement(UseDialogic, { ...props, instance: dialog });
}
...
function Dialog(props) {
  return /* @__PURE__ */ React.createElement(Dialogical, { ...props, instance: dialog });
}
function Notification(props) {
  return /* @__PURE__ */ React.createElement(Dialogical, { ...props, instance: notification });
}
...
exports.UseDialogic = UseDialogic;
...
exports.useDialog = useDialog;
exports.useDialogic = useDialogic;
exports.useDialogicState = useDialogicState;
exports.useNotification = useNotification;
exports.useRemaining = useRemaining;
//# sourceMappingURL=dialogic-react.cjs.map
