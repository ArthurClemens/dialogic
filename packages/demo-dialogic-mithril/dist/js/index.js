...
var DialogComponent = {
  view: function view(_ref) {
    ...
    return mithril__WEBPACK_IMPORTED_MODULE_1___default()(".mdc-dialog.mdc-dialog--open", [mithril__WEBPACK_IMPORTED_MODULE_1___default()(DialogContent, _objectSpread({}, attrs)), mithril__WEBPACK_IMPORTED_MODULE_1___default()(".mdc-dialog__scrim") // modal, onclick is not used
    ]);
  }
};
var DialogContent = {
  view: function view(_ref2) {
    ...
    return mithril__WEBPACK_IMPORTED_MODULE_1___default()(".mdc-dialog__container", mithril__WEBPACK_IMPORTED_MODULE_1___default()(".mdc-dialog__surface", [mithril__WEBPACK_IMPORTED_MODULE_1___default()("h2.mdc-dialog__title", attrs.title), mithril__WEBPACK_IMPORTED_MODULE_1___default()(".mdc-dialog__content", attrs.body), mithril__WEBPACK_IMPORTED_MODULE_1___default()("footer.mdc-dialog__actions", [mithril__WEBPACK_IMPORTED_MODULE_1___default()("button.mdc-button.mdc-dialog__button", {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_2__.dialog.hide();
        attrs.onReject();
      }
    }, mithril__WEBPACK_IMPORTED_MODULE_1___default()("span.mdc-button__label", "Never mind")), mithril__WEBPACK_IMPORTED_MODULE_1___default()("button.mdc-button.mdc-dialog__button", {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_2__.dialog.hide();
        attrs.onAccept();
      }
    }, mithril__WEBPACK_IMPORTED_MODULE_1___default()("span.mdc-button__label", "Yes, retry"))])]));
  }
};
...
var NotificationComponent = function NotificationComponent(props) {
  ...
  (0,dialogic__WEBPACK_IMPORTED_MODULE_3__.remaining)({
  ...
  return {
    view: function view() {
      return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-snackbar.mdc-snackbar--open', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-snackbar__surface', mithril__WEBPACK_IMPORTED_MODULE_0___default()(NotificationContent, {
...
var NotificationContent = {
  view: function view(_ref) {
    var attrs = _ref.attrs;
    return [mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-snackbar__label', attrs.remainingSeconds !== undefined ? "Can't send photo. Retrying in ".concat(attrs.remainingSeconds, " seconds.") : "Can't send photo."), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-snackbar__actions', mithril__WEBPACK_IMPORTED_MODULE_0___default()('button.mdc-button.mdc-snackbar__action', {
      onclick: function onclick() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RemainingLabel": () => (/* binding */ RemainingLabel)
/* harmony export */ });
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
...
var RemainingLabel = function RemainingLabel() {
  var remainingSeconds;
  (0,dialogic__WEBPACK_IMPORTED_MODULE_1__.remaining)({
...
var App = {
  view: function view() {
    return [mithril__WEBPACK_IMPORTED_MODULE_0___default()('.page', [mithril__WEBPACK_IMPORTED_MODULE_0___default()('main', [mithril__WEBPACK_IMPORTED_MODULE_0___default()('h1', 'Dialogic for Mithril demo'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.message', 'Add one or more notifications, then click on the Retry button in the message.'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.message', [mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.button.primary', {
      onclick: function onclick() {
    ...
    }, 'Add notification'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.button', {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.pause();
      }
    }, 'Pause'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.button', {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.resume();
      }
    }, 'Resume'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.button', {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.hideAll();
      }
    }, 'Hide all'), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.button', {
      onclick: function onclick() {
        dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.resetAll();
      }
    }, 'Reset all')]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.message', [mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.label', ['Notifications', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.detail', dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.getCount())]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.label', ['Is paused', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.detail', dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.isPaused().toString())]), dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.notification.exists() && mithril__WEBPACK_IMPORTED_MODULE_0___default()('.ui.label', ['Remaining', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.detail', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_RemainingLabel__WEBPACK_IMPORTED_MODULE_2__.RemainingLabel))])])]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('footer', [mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', mithril__WEBPACK_IMPORTED_MODULE_0___default().trust("Dialogic: manage dialogs and notifications. <a href='https://github.com/ArthurClemens/dialogic'>Main documentation on GitHub</a>"))])]), mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.Notification), mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__.Dialog)];
  }
};
var rootElement = document.getElementById('root');

if (rootElement) {
  mithril__WEBPACK_IMPORTED_MODULE_0___default().mount(rootElement, App);
}
})();
