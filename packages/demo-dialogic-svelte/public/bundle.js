var app = (function () {
    ...
    // (20:2) {#if remainingSeconds !== undefined}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("Can't send photo. Retry in ");
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(20:2) {#if remainingSeconds !== undefined}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 18, 0, 407);
    			attr_dev(button, "class", "button mdc-button mdc-snackbar__action");
    			add_location(button, file$3, 26, 2, 624);
    			attr_dev(div1, "class", "mdc-snackbar__actions");
    			add_location(div1, file$3, 25, 0, 586);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	remaining({
    		getRemaining: notification$1.getRemaining,
    		exists: () => notification$1.exists(),
    		roundToSeconds: true,
    		callback: newValue => {
    ...
    /* src/RemainingLabel.svelte generated by Svelte v3.16.5 */
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(t_value);
    			add_location(span, file$5, 19, 2, 373);
    			attr_dev(div, "class", "remaining svelte-bf7089");
    			add_location(div, file$5, 18, 0, 347);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("$notificationExists" in $$props) notificationExists.set($notificationExists = $$props.$notificationExists);
    	};
