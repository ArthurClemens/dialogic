var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t52 = space();
    			dialog2.$$.fragment.c();
    			add_location(h2, file$4, 113, 0, 2816);
    			add_location(p0, file$4, 115, 0, 2833);
    			add_location(hr0, file$4, 117, 0, 2872);
    			add_location(button0, file$4, 120, 2, 2888);
    			add_location(button1, file$4, 127, 2, 3021);
    			add_location(div0, file$4, 119, 0, 2880);
    			add_location(button2, file$4, 138, 2, 3214);
    			add_location(button3, file$4, 150, 2, 3427);
    			add_location(button4, file$4, 155, 2, 3525);
    			add_location(button5, file$4, 163, 2, 3658);
    			add_location(div1, file$4, 130, 0, 3082);
    			add_location(button6, file$4, 167, 2, 3777);
    			add_location(button7, file$4, 183, 2, 4185);
    			add_location(div2, file$4, 166, 0, 3769);
    			add_location(button8, file$4, 190, 2, 4335);
    			add_location(button9, file$4, 199, 2, 4564);
    			add_location(div3, file$4, 189, 0, 4327);
    			add_location(button10, file$4, 202, 2, 4657);
    			add_location(button11, file$4, 206, 2, 4775);
    			add_location(div4, file$4, 201, 0, 4649);
    			add_location(button12, file$4, 209, 2, 4868);
    			add_location(button13, file$4, 213, 2, 4989);
    			add_location(div5, file$4, 208, 0, 4860);
    			add_location(button14, file$4, 216, 2, 5083);
    			add_location(button15, file$4, 223, 2, 5257);
    			add_location(div6, file$4, 215, 0, 5075);
    			add_location(hr1, file$4, 226, 0, 5338);
    			add_location(p1, file$4, 229, 2, 5354);
    			add_location(div7, file$4, 228, 0, 5346);
    			add_location(p2, file$4, 234, 2, 5398);
    			add_location(div8, file$4, 233, 0, 5390);
    			add_location(hr2, file$4, 238, 0, 5461);
    			add_location(button16, file$4, 241, 2, 5490);
    			add_location(button17, file$4, 248, 2, 5687);
    			add_location(div9, file$4, 240, 0, 5482);
    			add_location(p3, file$4, 252, 2, 5770);
    			add_location(div10, file$4, 251, 0, 5762);
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t16 = space();
    			hr = element("hr");
    			add_location(h2, file$4, 264, 0, 5958);
    			add_location(p0, file$4, 265, 0, 5980);
    			add_location(p1, file$4, 266, 0, 6029);
    			add_location(button0, file$4, 269, 2, 6101);
    			add_location(button1, file$4, 289, 2, 6621);
    			add_location(button2, file$4, 295, 2, 6789);
    			add_location(button3, file$4, 300, 2, 6893);
    			add_location(div, file$4, 268, 0, 6093);
    			add_location(hr, file$4, 309, 0, 7026);
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button0, file$4, 99, 0, 2345);
    			add_location(button1, file$4, 101, 0, 2457);
    			add_location(button2, file$4, 103, 0, 2552);
    			add_location(button3, file$4, 105, 0, 2629);
    			add_location(hr0, file$4, 107, 0, 2712);
    			add_location(button4, file$4, 109, 0, 2720);
    			add_location(hr1, file$4, 258, 0, 5830);
    			add_location(button5, file$4, 260, 0, 5838);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let $dialogCount, $timerDialogCount, $notificationCount, $notificationItemIsPaused;
      ...
      const timerDialogCount = dialog$1.getCount({
        id: "timer"
      }); validate_store(timerDialogCount, 'timerDialogCount'); component_subscribe($$self, timerDialogCount, $$value => { $timerDialogCount = $$value; $$invalidate('$timerDialogCount', $timerDialogCount); });
