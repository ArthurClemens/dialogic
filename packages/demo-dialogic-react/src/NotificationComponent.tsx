...
const NotificationContent: FunctionComponent<TNotificationComponentProps> = (
  props
) => {
...
export const NotificationComponent: FunctionComponent<TNotificationComponentProps> =
  (props) => (
