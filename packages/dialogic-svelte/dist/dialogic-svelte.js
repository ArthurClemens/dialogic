...
const getCount = ns => identityOptions => derived(
	appState,
	() => selectors.getCount(ns, identityOptions)
);
const isPaused = ns => defaultDialogicOptions => identityOptions => derived(
	appState,
	() => isPaused$1(ns)(defaultDialogicOptions)(identityOptions)
);
const exists = ns => defaultDialogicOptions => identityOptions => derived(
	appState,
...
const dialog = {
  ...
  getCount: identityOptions =>
    getCount(dialog$1.ns)(identityOptions),
...
const notification = {
  ...notification$1,
  getCount: identityOptions =>
    getCount(notification$1.ns)(identityOptions),
  isPaused: identityOptions =>
    isPaused(notification$1.ns)(notification$1.defaultDialogicOptions)(identityOptions),
  exists: identityOptions =>
    exists(notification$1.ns)(notification$1.defaultDialogicOptions)(identityOptions),
};
...
/* src/Instance.svelte generated by Svelte v3.22.3 */
...
/* src/Wrapper.svelte generated by Svelte v3.22.3 */
...
/* src/Dialogical.svelte generated by Svelte v3.22.3 */
...
/* src/Dialog.svelte generated by Svelte v3.22.3 */
...
function create_fragment$3(ctx) {
	...
	const dialogical = new Dialogical({ props: dialogical_props });
...
/* src/Notification.svelte generated by Svelte v3.22.3 */
