...
/***/ "../../demo-dialogic-mithril-router/src/CurrentPathBadge.ts":
/*!************************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/CurrentPathBadge.ts ***!
  \************************************************************************************************************************/
...
const CurrentPathBadge = {
    view: () => {
        ...
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.control.path-control', mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.tag', { 'data-test-id': 'current-path' }, route));
    },
};
...
/***/ "../../demo-dialogic-mithril-router/src/EditProfileDialog.ts":
/*!*************************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/EditProfileDialog.ts ***!
  \*************************************************************************************************************************/
        ...
        view: ({ attrs }) => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { className: 'modal is-active', 'data-test-id': 'edit-profile-dialog' }, [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('form', {
                    ...
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('footer', { className: 'modal-card-foot' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('footer-buttons', [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                            type: 'submit',
...
/***/ "../../demo-dialogic-mithril-router/src/HomePage.ts":
/*!****************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/HomePage.ts ***!
  \****************************************************************************************************************/
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _CurrentPathBadge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CurrentPathBadge */ "../../demo-dialogic-mithril-router/src/CurrentPathBadge.ts");
...
const HomePage = {
    view: ({ attrs }) => {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { 'data-test-id': 'home-page' }, [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('p.intro', mithril__WEBPACK_IMPORTED_MODULE_0___default.a.trust("This demo shows the <code>useDialog</code> hook that allows for a declarative way of controlling dialogs. The Profile dialog responds to the route, and is automatically hidden when using the browser's back button.")),
...
/***/ "../../demo-dialogic-mithril-router/src/ProfilePage.ts":
/*!*******************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/ProfilePage.ts ***!
  \*******************************************************************************************************************/
...
/* harmony import */ var _EditProfileDialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./EditProfileDialog */ "../../demo-dialogic-mithril-router/src/EditProfileDialog.ts");
...
/* harmony import */ var _SaveConfirmation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SaveConfirmation */ "../../demo-dialogic-mithril-router/src/SaveConfirmation.ts");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./store */ "../../demo-dialogic-mithril-router/src/store.ts");
...
const ProfilePageFn = (attrs) => {
    ...
    Object(dialogic_mithril__WEBPACK_IMPORTED_MODULE_2__["useDialog"])({
        isShow: isRouteMatch,
        deps: [_store__WEBPACK_IMPORTED_MODULE_6__["store"].count],
        props: {
            dialogic: {
            ...
            pathPrefix,
            title: `Update your e-mail ${_store__WEBPACK_IMPORTED_MODULE_6__["store"].count}`,
            email: _store__WEBPACK_IMPORTED_MODULE_6__["store"].email,
            onSave: (newEmail) => {
                if (newEmail !== _store__WEBPACK_IMPORTED_MODULE_6__["store"].email) {
                    _store__WEBPACK_IMPORTED_MODULE_6__["store"].setEmail(newEmail);
            ...
            increment: _store__WEBPACK_IMPORTED_MODULE_6__["store"].increment,
        },
    });
    return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { 'data-test-id': 'profile-page' }, [
        ...
        mithril__WEBPACK_IMPORTED_MODULE_0___default()(_CurrentPathBadge__WEBPACK_IMPORTED_MODULE_1__["CurrentPathBadge"]),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.profile-tile', [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', mithril__WEBPACK_IMPORTED_MODULE_0___default()('strong', 'Email')),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { 'data-test-id': 'current-email' }, _store__WEBPACK_IMPORTED_MODULE_6__["store"].email),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()(mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.Link, {
                className: 'button is-link',
                href: dialogPath,
...
/***/ "../../demo-dialogic-mithril-router/src/SaveConfirmation.ts":
/*!************************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/SaveConfirmation.ts ***!
  \************************************************************************************************************************/
...
/***/ "../../demo-dialogic-mithril-router/src/store.ts":
/*!*************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/store.ts ***!
  \*************************************************************************************************************/
...
const store = {
    ...
    setEmail: (newEmail) => (store.email = newEmail),
};


/***/ }),

/***/ "../../demo-dialogic-mithril-router/src/styles.css":
/*!***************************************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/dialogic/master/packages/demo-dialogic-mithril-router/src/styles.css ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!**********************************************************************************************************!*\
  ...
  \**********************************************************************************************************/
/*! exports provided: sharedUseDialog, sharedUseDialogic, sharedUseNotification, sharedUseRemaining */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sharedUseRemaining", function() { return sharedUseRemaining; });
...
var sharedUseDialogic = function sharedUseDialogic(_ref) {
  ...
  return function (allProps) {
    ...
    }, [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(deps), [isShow])); // maybe hide
    ...
    }, [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(deps), [isHide])); // unmount
...
var sharedUseRemaining = function sharedUseRemaining(_ref4) {
  var useState = _ref4.useState,
      useMemo = _ref4.useMemo;
  return function (props) {
    ...
    var exists = !!props.instance.exists(identity);
    useMemo(function () {
      if (exists) {
        Object(dialogic__WEBPACK_IMPORTED_MODULE_3__["remaining"])(_objectSpread(_objectSpread({}, identity), {}, {
...
/*!**************************************************************************************************************!*\
  ...
  \**************************************************************************************************************/
/*! exports provided: dialog, notification, Dialog, Dialogical, Notification, useDialog, useDialogic, useNotification, useRemaining */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var useDialogic = Object(dialogic_hooks__WEBPACK_IMPORTED_MODULE_4__["sharedUseDialogic"])({
  ...
  useState: mithril_hooks__WEBPACK_IMPORTED_MODULE_3__["useState"]
});
...
var useRemaining = Object(dialogic_hooks__WEBPACK_IMPORTED_MODULE_4__["sharedUseRemaining"])({
  useMemo: mithril_hooks__WEBPACK_IMPORTED_MODULE_3__["useMemo"],
  useState: mithril_hooks__WEBPACK_IMPORTED_MODULE_3__["useState"]
});
...
var remaining = function remaining(props) {
  ...
  var update = function update() {
    var remaining = props.instance.getRemaining(identity);
...
const Default = {
    view: ({ attrs }) => mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', {
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _helpers_createFns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/createFns */ "./cypress-tests/helpers/createFns.ts");
/* harmony import */ var _content_Default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../content/Default */ "./content/Default.ts");
/* harmony import */ var _helpers_buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/buttons */ "./cypress-tests/helpers/buttons.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].resetAll();
    const fns = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        title: 'DialogClassName',
    });
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])(fns), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"]))]);
        },
    };
});
...
/***/ "./cypress-tests/DialogClassNameDelay.ts":
/*!***********************************************!*\
  !*** ./cypress-tests/DialogClassNameDelay.ts ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    const fns1 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        title: 'Default',
    });
    const fns2 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        id: '1',
    ...
    const fns3 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        spawn: '1',
    ...
    const fns4 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        spawn: '1',
    ...
    const fns5 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
        className: 'dialog',
        spawn: '2',
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-all' }, `Count all: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-id' }, `Count id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ id: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn' }, `Count spawn: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn-id' }, `Count spawn, id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: '1', id: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn-queued' }, `Count spawn, queued: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: '2' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 }),
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns2, id: '1' }),
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns3, spawn: '1' }),
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns4, spawn: '1', id: '1' }),
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns5, spawn: '5', name: 'queued' }),
                ]),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.custom-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"], { spawn: '1' })),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.custom-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"], { spawn: '2' })),
            ]);
        },
    };
});
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-all' }, `Exists any: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].exists().toString()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-id' }, `Exists id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].exists({ id: '1' }).toString()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn' }, `Exists spawn: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].exists({ spawn: '1' }).toString()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn-id' }, `Exists spawn, id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"]
                    .exists({ spawn: '1', id: '1' })
                    .toString()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 }),
...
/***/ "./cypress-tests/DialogHideAll.ts":
/*!****************************************!*\
  !*** ./cypress-tests/DialogHideAll.ts ***!
  \****************************************/
/*! exports provided: default */
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn' }, `Count spawn: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn-id' }, `Count spawn, id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: '1', id: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'hide-all' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].hideAll(),
                        'data-test-id': 'button-hide-all',
                    }, 'Hide all'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].hideAll({ styles: hideAllStyles }),
                        'data-test-id': 'button-hide-all-simultaneous',
                    }, 'Hide all simulaneously'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].hideAll({ id: '1' }),
                        'data-test-id': 'button-hide-all-id',
                    }, 'Hide all with id'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].hideAll({ spawn: '1' }),
                        'data-test-id': 'button-hide-all-spawn',
                    }, 'Hide all with spawn'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].hideAll({ id: '1', spawn: '1' }),
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 }),
                Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns2, id: '1' }),
                Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns3, id: '2' }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"])),
            ]);
        },
    };
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-all' }, `Count all: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 })]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"])),
            ]);
        },
    };
...
/***/ "./cypress-tests/DialogResetAll.ts":
/*!*****************************************!*\
  !*** ./cypress-tests/DialogResetAll.ts ***!
  \*****************************************/
/*! exports provided: default */
        ...
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'reset-all' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    ...
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].resetAll({ id: '1' }),
                        'data-test-id': 'button-reset-all-id',
                    }, 'Reset all with id'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].resetAll({ spawn: '1' }),
                        'data-test-id': 'button-reset-all-spawn',
                    }, 'Reset all with spawn'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].resetAll({ id: '1', spawn: '1' }),
...
/* harmony import */ var _helpers_buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/buttons */ "./cypress-tests/helpers/buttons.ts");
/* harmony import */ var dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dialogic-mithril */ "../../dialogic-mithril/dist/dialogic-mithril.mjs");
/* harmony import */ var _helpers_RemainingWithAnimationFrame__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers/RemainingWithAnimationFrame */ "./cypress-tests/helpers/RemainingWithAnimationFrame.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', { key: new Date().getTime() }, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'reset-all' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_RemainingWithAnimationFrame__WEBPACK_IMPORTED_MODULE_5__["RemainingWithAnimationFrame"], {
                    key: 'DialogTimeout',
                    getRemaining: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getRemaining,
                })),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 })]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"])),
            ]);
...
/***/ "./cypress-tests/LibBulmaDialog.ts":
/*!*****************************************!*\
  !*** ./cypress-tests/LibBulmaDialog.ts ***!
  \*****************************************/
/*! exports provided: default */
...
const DemoContent = {
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()('article', { class: 'media' }, [
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { class: 'media-left' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('figure', { class: 'image is-64x64' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('img', {
            src: 'https://bulma.io/images/placeholders/128x128.png',
            alt: 'Image',
        }))),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { class: 'media-content' }, [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { class: 'content' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('p', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('strong', 'John Smith'),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('small', ' '),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('small', '@johnsmith'),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('small', '31m'),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('br'),
                ' Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean efficitur sit amet massa fringilla egestas. Nullam condimentum luctus turpis. ',
            ])),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('nav', { class: 'level is-mobile' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { class: 'level-left' }, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('a', { class: 'level-item', 'aria-label': 'retweet' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', { class: 'icon is-small' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('svg', {
                    ...
                    viewBox: '0 0 640 512',
                    'data-fa-i2svg': '',
                }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('path', {
                    fill: 'currentColor',
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('a', { class: 'level-item', 'aria-label': 'like' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', { class: 'icon is-small' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('svg', {
...
const BulmaDialogComponent = (isModal = false) => ({
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()('.modal.is-active', [
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('.modal-background', {
            onclick: () => !isModal && dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["dialog"].hide(),
        }),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('.modal-content', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.bulma-dialog-content-box', mithril__WEBPACK_IMPORTED_MODULE_0___default()(DemoContent))),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('.modal-close.is-large', {
            onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["dialog"].hide(),
        }),
    ]),
});
/* harmony default export */ __webpack_exports__["default"] = (() => {
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.bulma', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["Dialog"])),
            ]);
        },
    };
});
...
/***/ "./cypress-tests/LibMaterialIODialog.ts":
/*!**********************************************!*\
  !*** ./cypress-tests/LibMaterialIODialog.ts ***!
  \**********************************************/
/*! exports provided: default */
...
const DialogContent = {
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-dialog__container', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-dialog__surface', [
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('h2.mdc-dialog__title', 'Dialog Title'),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-dialog__content', 'Dialog body text goes here.'),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('footer.mdc-dialog__actions', [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('button.mdc-button.mdc-dialog__button', mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.mdc-button__label', {
                onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["dialog"].hide(),
            }, 'No')),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('button.mdc-button.mdc-dialog__button', mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.mdc-button__label', {
                onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["dialog"].hide(),
...
const MaterialIODialogComponent = (isModal = false) => ({
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-dialog.mdc-dialog--open', [
        mithril__WEBPACK_IMPORTED_MODULE_0___default()(DialogContent),
        mithril__WEBPACK_IMPORTED_MODULE_0___default()('.mdc-dialog__scrim', {
            onclick: () => !isModal && dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["dialog"].hide(),
        }),
    ]),
});
/* harmony default export */ __webpack_exports__["default"] = ({
    view: () => {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('.materialIO', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["Dialog"])),
        ]);
    },
});
...
/***/ "./cypress-tests/NotificationCount.ts":
/*!********************************************!*\
  !*** ./cypress-tests/NotificationCount.ts ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].resetAll();
    const fns1 = Object(_helpers_createFns__WEBPACK_IMPORTED_MODULE_1__["createFns"])({
        instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"],
        component: _content_Default__WEBPACK_IMPORTED_MODULE_2__["Default"],
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-all' }, `Count all: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getCount()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-id' }, `Count id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getCount({ id: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn' }, `Count spawn: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getCount({ spawn: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'count-spawn-id' }, `Count spawn, id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getCount({ spawn: '1', id: '1' })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                    className: 'button',
                    onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].resetAll(),
                    'data-test-id': 'button-reset',
                }, 'Reset')),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 }),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"])),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.custom-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"], { spawn: '1' })),
            ]);
        },
    };
});
...
/***/ "./cypress-tests/NotificationPause.ts":
/*!********************************************!*\
  !*** ./cypress-tests/NotificationPause.ts ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.section', { 'data-test-id': 'pause-default' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'pause-default' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].pause(),
                        'data-test-id': 'button-pause',
                    }, 'Pause'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].resume(),
                        'data-test-id': 'button-resume',
                    }, 'Resume'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                ...
                ])), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'is-paused' }, `Is paused: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].isPaused()}`), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_RemainingWithAnimationFrame__WEBPACK_IMPORTED_MODULE_5__["RemainingWithAnimationFrame"], {
                    key: 'NotificationPause',
                    getRemaining: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getRemaining,
                })), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 })]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"]))),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.section', { 'data-test-id': 'pause-id' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].pause({ spawn: '2' }),
                        'data-test-id': 'button-pause',
                    }, 'Pause'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].resume({ spawn: '2' }),
                        'data-test-id': 'button-resume',
                    }, 'Resume'),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('button', {
                        className: 'button',
                        onclick: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].resetAll({ spawn: '2' }),
                        'data-test-id': 'button-reset',
                    }, 'Reset'),
                ])), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'is-paused' }, `Is paused: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].isPaused({ spawn: '2' })}`), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_RemainingWithAnimationFrame__WEBPACK_IMPORTED_MODULE_5__["RemainingWithAnimationFrame"], {
                    key: 'NotificationPause',
                    getRemaining: () => dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].getRemaining({ spawn: '2' }),
                })), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns2, name: 'spawn' })]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.custom-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"], { spawn: '2' }))),
            ]);
        },
    };
});
...
/***/ "./cypress-tests/NotificationTimeout.ts":
/*!**********************************************!*\
  !*** ./cypress-tests/NotificationTimeout.ts ***!
  \**********************************************/
/*! exports provided: default */
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'is-paused' }, `Is paused: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].isPaused()}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_RemainingWithAnimationFrame__WEBPACK_IMPORTED_MODULE_5__["RemainingWithAnimationFrame"], {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 }),
                    Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns2, id: '1', name: 'zero-timeout' }),
                ]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"])),
            ]);
        },
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _demo_dialogic_mithril_router_src_HomePage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../demo-dialogic-mithril-router/src/HomePage */ "../../demo-dialogic-mithril-router/src/HomePage.ts");
/* harmony import */ var _demo_dialogic_mithril_router_src_ProfilePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../demo-dialogic-mithril-router/src/ProfilePage */ "../../demo-dialogic-mithril-router/src/ProfilePage.ts");
/* harmony import */ var _demo_dialogic_mithril_router_src_styles_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../demo-dialogic-mithril-router/src/styles.css */ "../../demo-dialogic-mithril-router/src/styles.css");
/* harmony import */ var _demo_dialogic_mithril_router_src_styles_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_demo_dialogic_mithril_router_src_styles_css__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dialogic-mithril */ "../../dialogic-mithril/dist/dialogic-mithril.mjs");
...
const resolve = (component) => ({
    render: () => {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.app', [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()(component, { pathPrefix: PREFIX }),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"]),
        ]);
    },
});
const routes = [
    { path: PREFIX, component: resolve(_demo_dialogic_mithril_router_src_HomePage__WEBPACK_IMPORTED_MODULE_1__["HomePage"]), showInMenu: true },
    { path: `${PREFIX}/profile`, component: resolve(_demo_dialogic_mithril_router_src_ProfilePage__WEBPACK_IMPORTED_MODULE_2__["ProfilePage"]) },
    { path: `${PREFIX}/profile/:cmd`, component: resolve(_demo_dialogic_mithril_router_src_ProfilePage__WEBPACK_IMPORTED_MODULE_2__["ProfilePage"]) },
];


/***/ }),

/***/ "./cypress-tests/UseRemaining.ts":
/*!***************************************!*\
  !*** ./cypress-tests/UseRemaining.ts ***!
  \***************************************/
/*! exports provided: default */
...
/* harmony import */ var _helpers_buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/buttons */ "./cypress-tests/helpers/buttons.ts");
/* harmony import */ var dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dialogic-mithril */ "../../dialogic-mithril/dist/dialogic-mithril.mjs");
/* harmony import */ var _helpers_Remaining__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers/Remaining */ "./cypress-tests/helpers/Remaining.ts");
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('.test', [
                ...
                ])), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'is-paused' }, `Is paused: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].isPaused()}`), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_Remaining__WEBPACK_IMPORTED_MODULE_5__["Remaining"], {
                    key: 'NotificationPause',
                    instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"],
                })), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns1 })]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.default-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"]))),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.section', { 'data-test-id': 'pause-id' }, mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                ...
                ])), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', { 'data-test-id': 'is-paused' }, `Is paused: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"].isPaused({ spawn: '2' })}`), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.control', mithril__WEBPACK_IMPORTED_MODULE_0___default()(_helpers_Remaining__WEBPACK_IMPORTED_MODULE_5__["Remaining"], {
                    key: 'NotificationPause',
                    instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["notification"],
                    spawn: '2'
                })), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.content', [Object(_helpers_buttons__WEBPACK_IMPORTED_MODULE_3__["buttons"])({ ...fns2, name: 'spawn' })]), mithril__WEBPACK_IMPORTED_MODULE_0___default()('.spawn.custom-spawn', mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Notification"], { spawn: '2' }))),
...
/***/ "./cypress-tests/helpers/Remaining.ts":
/*!********************************************!*\
  !*** ./cypress-tests/helpers/Remaining.ts ***!
  \********************************************/
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dialogic-mithril */ "../../dialogic-mithril/dist/dialogic-mithril.mjs");
/* harmony import */ var mithril_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mithril-hooks */ "../node_modules/mithril-hooks/dist/mithril-hooks.mjs");



const _Remaining = ({ instance, spawn, id }) => {
    const [displayValue] = Object(dialogic_mithril__WEBPACK_IMPORTED_MODULE_1__["useRemaining"])({
        instance,
        spawn,
        id,
    });
    return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', { 'data-test-id': 'remaining' }, [
...
const Remaining = Object(mithril_hooks__WEBPACK_IMPORTED_MODULE_2__["withHooks"])(_Remaining);


/***/ }),

/***/ "./cypress-tests/helpers/RemainingWithAnimationFrame.ts":
/*!**************************************************************!*\
  !*** ./cypress-tests/helpers/RemainingWithAnimationFrame.ts ***!
  \**************************************************************/
/*! exports provided: RemainingWithAnimationFrame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RemainingWithAnimationFrame", function() { return RemainingWithAnimationFrame; });
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);

const RemainingWithAnimationFrame = ({ attrs }) => {
    let displayValue = 0;
    let reqId;
    const update = () => {
...
/***/ "./cypress-tests/helpers/buttons.ts":
/*!******************************************!*\
  !*** ./cypress-tests/helpers/buttons.ts ***!
  \******************************************/
...
const buttons = ({ showFn, hideFn, id, spawn, name }) => {
    const genName = name ||
...
/***/ "./cypress-tests/helpers/createFns.ts":
/*!********************************************!*\
  !*** ./cypress-tests/helpers/createFns.ts ***!
  \********************************************/
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./cypress-tests/helpers/utils.ts");
...
const createFns = ({ instance, component, className, title, id, spawn, styles, timeout, queued, }) => {
    ...
    const hideFn = () => instance.hide({
        ...props,
        title: `${title} ${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getRandomId"])()} hiding`,
    });
    return {
        showFn,
        hideFn,
...
/***/ "./cypress-tests/helpers/utils.ts":
/*!****************************************!*\
  !*** ./cypress-tests/helpers/utils.ts ***!
  \****************************************/
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "../node_modules/mithril/mithril.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _cypress_tests_DialogClassName__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cypress-tests/DialogClassName */ "./cypress-tests/DialogClassName.ts");
/* harmony import */ var _cypress_tests_DialogClassNameDelay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cypress-tests/DialogClassNameDelay */ "./cypress-tests/DialogClassNameDelay.ts");
/* harmony import */ var _cypress_tests_DialogStyles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cypress-tests/DialogStyles */ "./cypress-tests/DialogStyles.ts");
/* harmony import */ var _cypress_tests_DialogIds__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cypress-tests/DialogIds */ "./cypress-tests/DialogIds.ts");
/* harmony import */ var _cypress_tests_DialogExists__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cypress-tests/DialogExists */ "./cypress-tests/DialogExists.ts");
/* harmony import */ var _cypress_tests_DialogCount__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cypress-tests/DialogCount */ "./cypress-tests/DialogCount.ts");
/* harmony import */ var _cypress_tests_DialogHideAll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cypress-tests/DialogHideAll */ "./cypress-tests/DialogHideAll.ts");
/* harmony import */ var _cypress_tests_DialogResetAll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./cypress-tests/DialogResetAll */ "./cypress-tests/DialogResetAll.ts");
/* harmony import */ var _cypress_tests_DialogTimeout__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cypress-tests/DialogTimeout */ "./cypress-tests/DialogTimeout.ts");
/* harmony import */ var _cypress_tests_DialogQueued__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cypress-tests/DialogQueued */ "./cypress-tests/DialogQueued.ts");
/* harmony import */ var _cypress_tests_NotificationCount__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cypress-tests/NotificationCount */ "./cypress-tests/NotificationCount.ts");
/* harmony import */ var _cypress_tests_NotificationPause__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./cypress-tests/NotificationPause */ "./cypress-tests/NotificationPause.ts");
/* harmony import */ var _cypress_tests_NotificationTimeout__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cypress-tests/NotificationTimeout */ "./cypress-tests/NotificationTimeout.ts");
/* harmony import */ var _cypress_tests_UseRemaining__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./cypress-tests/UseRemaining */ "./cypress-tests/UseRemaining.ts");
/* harmony import */ var _cypress_tests_LibBulmaDialog__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./cypress-tests/LibBulmaDialog */ "./cypress-tests/LibBulmaDialog.ts");
/* harmony import */ var _cypress_tests_LibMaterialIODialog__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./cypress-tests/LibMaterialIODialog */ "./cypress-tests/LibMaterialIODialog.ts");
/* harmony import */ var _cypress_tests_UseDialog__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./cypress-tests/UseDialog */ "./cypress-tests/UseDialog.ts");
/* harmony import */ var _app_styles_css__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./app-styles.css */ "./app-styles.css");
/* harmony import */ var _app_styles_css__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_app_styles_css__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _test_styles_css__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./test-styles.css */ "./test-styles.css");
/* harmony import */ var _test_styles_css__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_test_styles_css__WEBPACK_IMPORTED_MODULE_19__);
...
const Home = {
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()('.menu', mithril__WEBPACK_IMPORTED_MODULE_0___default()('ul', routes
        .filter(({ showInMenu }) => !!showInMenu)
        .map(({ path }) => mithril__WEBPACK_IMPORTED_MODULE_0___default()('li', mithril__WEBPACK_IMPORTED_MODULE_0___default()(mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.Link, { href: path }, path.substr(1)))))),
};
const routes = [
    { path: '/', component: Home, showInMenu: true },
    { path: '/DialogClassName', component: _cypress_tests_DialogClassName__WEBPACK_IMPORTED_MODULE_1__["default"], showInMenu: true },
    {
        path: '/DialogClassNameDelay',
        component: _cypress_tests_DialogClassNameDelay__WEBPACK_IMPORTED_MODULE_2__["default"],
        showInMenu: true,
    },
    { path: '/DialogStyles', component: _cypress_tests_DialogStyles__WEBPACK_IMPORTED_MODULE_3__["default"], showInMenu: true },
    { path: '/DialogIds', component: _cypress_tests_DialogIds__WEBPACK_IMPORTED_MODULE_4__["default"], showInMenu: true },
    { path: '/DialogExists', component: _cypress_tests_DialogExists__WEBPACK_IMPORTED_MODULE_5__["default"], showInMenu: true },
    { path: '/DialogCount', component: _cypress_tests_DialogCount__WEBPACK_IMPORTED_MODULE_6__["default"], showInMenu: true },
    { path: '/DialogHideAll', component: _cypress_tests_DialogHideAll__WEBPACK_IMPORTED_MODULE_7__["default"], showInMenu: true },
    { path: '/DialogResetAll', component: _cypress_tests_DialogResetAll__WEBPACK_IMPORTED_MODULE_8__["default"], showInMenu: true },
    { path: '/DialogTimeout', component: _cypress_tests_DialogTimeout__WEBPACK_IMPORTED_MODULE_9__["default"], showInMenu: true },
    { path: '/DialogQueued', component: _cypress_tests_DialogQueued__WEBPACK_IMPORTED_MODULE_10__["default"], showInMenu: true },
    {
        path: '/NotificationCount',
        component: _cypress_tests_NotificationCount__WEBPACK_IMPORTED_MODULE_11__["default"],
        showInMenu: true,
    },
    {
        path: '/NotificationPause',
        component: _cypress_tests_NotificationPause__WEBPACK_IMPORTED_MODULE_12__["default"],
        showInMenu: true,
    },
    {
        path: '/NotificationTimeout',
        component: _cypress_tests_NotificationTimeout__WEBPACK_IMPORTED_MODULE_13__["default"],
        showInMenu: true,
    },
    { path: '/LibBulmaDialog', component: _cypress_tests_LibBulmaDialog__WEBPACK_IMPORTED_MODULE_15__["default"], showInMenu: true },
    {
        path: '/LibMaterialIODialog',
        component: _cypress_tests_LibMaterialIODialog__WEBPACK_IMPORTED_MODULE_16__["default"],
        showInMenu: true,
    },
    {
        path: '/UseRemaining',
        component: _cypress_tests_UseRemaining__WEBPACK_IMPORTED_MODULE_14__["default"],
        showInMenu: true,
    },
    ..._cypress_tests_UseDialog__WEBPACK_IMPORTED_MODULE_17__["routes"],
];
mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.prefix = '#';
const mountNode = document.getElementById('root');
if (mountNode) {
    mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route(mountNode, '/', routes.reduce((acc, entry) => {
