    ...
    return function () {
      ...
      return new Promise(function (resolve) {
        ...
        if (maybeExistingItem.just && dialogicOptions.toggle) {
          var hideResult = hide(ns)(defaultDialogicOptions)(identityOptions);
...
var getValidItems = function getValidItems(ns, defaultDialogicOptions, dialogicOptions) {
  var allItems = selectors.getAll(ns);
  var validItems;

  if (dialogicOptions) {
    var combinedOptions = _objectSpread({}, defaultDialogicOptions, {}, dialogicOptions);
...
var resetAll = function resetAll(ns) {
  return function (defaultDialogicOptions) {
    return function (dialogicOptions) {
      var validItems = getValidItems(ns, defaultDialogicOptions, dialogicOptions);
      var items = [];
...
/* harmony import */ var _cypress_tests_DialogQueued__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cypress-tests/DialogQueued */ "./cypress-tests/DialogQueued.ts");
/* harmony import */ var _cypress_tests_NotificationCount__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cypress-tests/NotificationCount */ "./cypress-tests/NotificationCount.ts");
/* harmony import */ var _cypress_tests_NotificationPause__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cypress-tests/NotificationPause */ "./cypress-tests/NotificationPause.ts");
/* harmony import */ var _cypress_tests_NotificationTimeout__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./cypress-tests/NotificationTimeout */ "./cypress-tests/NotificationTimeout.ts");
/* harmony import */ var _cypress_tests_LibBulmaDialog__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cypress-tests/LibBulmaDialog */ "./cypress-tests/LibBulmaDialog.ts");
/* harmony import */ var _cypress_tests_LibMaterialIODialog__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./cypress-tests/LibMaterialIODialog */ "./cypress-tests/LibMaterialIODialog.ts");
/* harmony import */ var _app_styles_css__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app-styles.css */ "./app-styles.css");
/* harmony import */ var _app_styles_css__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_app_styles_css__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _test_styles_css__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./test-styles.css */ "./test-styles.css");
/* harmony import */ var _test_styles_css__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_test_styles_css__WEBPACK_IMPORTED_MODULE_16__);
...
const routes = {
    ...
    "/DialogQueued": _cypress_tests_DialogQueued__WEBPACK_IMPORTED_MODULE_9__["default"],
    "/NotificationCount": _cypress_tests_NotificationCount__WEBPACK_IMPORTED_MODULE_10__["default"],
    "/NotificationPause": _cypress_tests_NotificationPause__WEBPACK_IMPORTED_MODULE_11__["default"],
    "/NotificationTimeout": _cypress_tests_NotificationTimeout__WEBPACK_IMPORTED_MODULE_12__["default"],
    "/LibBulmaDialog": _cypress_tests_LibBulmaDialog__WEBPACK_IMPORTED_MODULE_13__["default"],
    "/LibMaterialIODialog": _cypress_tests_LibMaterialIODialog__WEBPACK_IMPORTED_MODULE_14__["default"],
};
