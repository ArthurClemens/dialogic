...
var resetAll = function resetAll(ns) {
  return function (defaultDialogicOptions) {
    return function (dialogicOptions) {
      ...
      var validItems = dialogicOptions ? filterBySpawnOption(_objectSpread({}, defaultDialogicOptions, {}, dialogicOptions))(allItems) : allItems;
      var items = [];
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(".test", [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["Dialog"], { spawn: "1" }),
            ]);
        }
    };
});
    ...
    return {
        view: () => {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(".test", [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(".control", { "data-test-id": "count-spawn" }, `Count spawn: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: "1" })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(".control", { "data-test-id": "count-spawn-id" }, `Count spawn, id: ${dialogic_mithril__WEBPACK_IMPORTED_MODULE_4__["dialog"].getCount({ spawn: "1", id: "1" })}`),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(".control", { "data-test-id": "hide0all" }, mithril__WEBPACK_IMPORTED_MODULE_0___default()("button", {
                    className: "button",
