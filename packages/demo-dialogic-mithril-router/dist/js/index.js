...
/* harmony import */ var _CurrentPathBadge__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CurrentPathBadge */ "./CurrentPathBadge.ts");
/* harmony import */ var dialogic_mithril__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dialogic-mithril */ "../../dialogic-mithril/dist/dialogic-mithril.mjs");
/* harmony import */ var _EditProfileDialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./EditProfileDialog */ "./EditProfileDialog.ts");
...
const useDialogic = (allProps) => {
    const { instance, $isShow, props = {} } = allProps;
...
const useDialog = (props) => useDialogic({ ...props, instance: dialogic_mithril__WEBPACK_IMPORTED_MODULE_3__["dialog"] });
const ProfilePage = () => {
    const dialogPath = '/profile/edit';
    const returnPath = '/profile';
    const $isShow = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()(false);
    useDialog({
        $isShow,
        props: {
            dialogic: {
                component: _EditProfileDialog__WEBPACK_IMPORTED_MODULE_4__["EditProfileDialog"],
                className: 'dialog',
                queued: true,
                id: 'edit-profile',
                didHide: () => {
    ...
    return {
        onupdate: () => {
            ...
            $isShow(mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.get() === dialogPath);
        ...
        view: () => {
            ...
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()(_CurrentPathBadge__WEBPACK_IMPORTED_MODULE_2__["CurrentPathBadge"]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('.buttons', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()(mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.Link, { className: 'button', href: '/' }, 'Go to home'),
...
const appLayout = (Component) => ({
    view: () => mithril__WEBPACK_IMPORTED_MODULE_0___default()(App, mithril__WEBPACK_IMPORTED_MODULE_0___default()(Component)),
});
const AppWithProfilePage = appLayout(_ProfilePage__WEBPACK_IMPORTED_MODULE_2__["ProfilePage"]);
const rootElement = document.getElementById('root');
if (rootElement) {
    mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route(rootElement, '/', {
        '/': appLayout(_HomePage__WEBPACK_IMPORTED_MODULE_3__["HomePage"]),
